...
function color-help {
  echo -e " Color Usage"
  echo 
  echo -e " ${echo_bold_white}NORMAL${echo_reset_color}"
  echo
  echo -e "    ${echo_black}black${echo_reset_color}"
  echo -e "    ${echo_red}red${echo_reset_color}"
  echo -e "    ${echo_green}green${echo_reset_color}"
  echo -e "    ${echo_yellow}yellow${echo_reset_color}"
  echo -e "    ${echo_blue}blue${echo_reset_color}"
  echo -e "    ${echo_purple}purple${echo_reset_color}"
  echo -e "    ${echo_cyan}cyan${echo_reset_color}"
  echo -e "    ${echo_white}white${echo_reset_color}"
  echo -e "    ${echo_orange}orange${echo_reset_color}"
  echo
  echo -e " ${echo_bold_white}BOLD${echo_reset_color}"
  echo
  echo -e "    ${echo_bold_black}bold_black${echo_reset_color}"
  echo -e "    ${echo_bold_red}bold_red${echo_reset_color}"
  echo -e "    ${echo_bold_green}bold_green${echo_reset_color}"
  echo -e "    ${echo_bold_yellow}bold_yellow${echo_reset_color}"
  echo -e "    ${echo_bold_blue}bold_blue${echo_reset_color}"
  echo -e "    ${echo_bold_purple}bold_purple${echo_reset_color}"
  echo -e "    ${echo_bold_cyan}bold_cyan${echo_reset_color}"
  echo -e "    ${echo_bold_white}bold_white${echo_reset_color}"
  echo -e "    ${echo_bold_orange}bold_orange${echo_reset_color}"
  echo
  echo -e " ${echo_bold_white}UNDERLINE${echo_reset_color}"
  echo
  echo -e "    ${echo_underline_black}underline_black${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_red}underline_red${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_green}underline_green${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_yellow}underline_yellow${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_blue}underline_blue${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_purple}underline_purple${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_cyan}underline_cyan${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_white}underline_white${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_underline_orange}underline_orange${echo_reset_color}${echo_normal}"
  echo
  echo -e " ${echo_bold_white}BACKGROUND${echo_reset_color}"
  echo
  echo -e "    ${echo_background_black}background_black${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_red}background_red${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_green}background_green${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_yellow}background_yellow${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_blue}background_blue${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_purple}background_purple${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_cyan}background_cyan${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_white}background_white${echo_reset_color}${echo_normal}"
  echo -e "    ${echo_background_orange}background_orange${echo_reset_color}${echo_normal}" 
  echo
}
