...
function install_boost() {
  ...
  if [ ! -e "${installdir}/include" -o ! -e "${installdir}/lib" ]; then
      # TODO: Patch boost_1_54_0/libs/iostreams/build/Jamfile.v2
      info__ "[WARN] Patching boost_1_54_0/libs/iostreams/build/Jamfile.v2"
      curl -s https://gist.githubusercontent.com/justintoo/d60221c333b6419cf809/raw/6e8f335ba80ea988bd77851cebb4de74c737ef9a/boost-iostream-Jamfile2.patch > \
          "${srcdir}/libs/iostreams/build/Jamfile.v2"
